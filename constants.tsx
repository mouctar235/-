...
export const SCHOOL_NAME = "نظام إدارة المدارس المتكامل";
...
export const Icons = {
  ...
  Teacher: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
